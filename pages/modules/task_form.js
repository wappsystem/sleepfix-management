...
var participant_sql	="Convert(varchar,UID)+'-'+JSON_VALUE(Information,'$.First_Name')+' '+JSON_VALUE(Information,'$.Last_Name')";
var participant_name =function(p_record){ return p_record.First_Name+" "+p_record.Last_Name;}
//-------------------------------------
